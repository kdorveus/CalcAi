    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.paragraph}>
          Welcome to calcAI. By accessing or using our mobile application (the "Application"), you
          agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms,
          please do not use the Application. We reserve the right to modify these Terms at any time,
          and your continued use of the Application constitutes acceptance of any changes.
        </Text>

        <Text style={styles.heading}>2. Description of Service</Text>
        <Text style={styles.paragraph}>
          calcAI is a voice-activated calculator application that allows users to perform
          mathematical calculations using voice commands. The Application may include features such
          as:
        </Text>
        ...
        <Text style={styles.paragraph}>
          To access certain features of the Application, you may be required to create an account
          using Google Sign-In. You are responsible for:
        </Text>
        ...
        <Text style={styles.paragraph}>
          calcAI offers premium subscription services that provide access to additional features.
        ...
        <Text style={styles.listItem}>
          - Premium features may be modified or discontinued at our discretion
        </Text>
        <Text style={styles.paragraph}>
          For lifetime subscriptions, "lifetime" refers to the operational lifetime of the
          Application, not the user's lifetime.
        </Text>

        <Text style={styles.heading}>5. Acceptable Use</Text>
        <Text style={styles.paragraph}>You agree not to use the Application to:</Text>
        ...
        <Text style={styles.paragraph}>
          The Application and its original content, features, and functionality are owned by calcAI
          (a TearHappy company) and are protected by international copyright, trademark, patent,
          trade secret, and other intellectual property laws. You may not copy, modify, distribute,
          sell, or lease any part of our Application without our express written permission.
        </Text>

        <Text style={styles.heading}>7. User-Generated Content</Text>
        <Text style={styles.paragraph}>
          Any calculations, webhook configurations, or other data you create using the Application
          remain your property. However, by using the Application, you grant us a limited license to
          store, process, and transmit this data as necessary to provide the service. We do not
          claim ownership of your data.
        </Text>

        <Text style={styles.heading}>8. Privacy and Data Protection</Text>
        <Text style={styles.paragraph}>
          Your use of the Application is also governed by our Privacy Policy. We do not record or
          store your voice data. All voice processing occurs locally on your device. Please review
        ...
        <Text style={styles.paragraph}>
          calcAI is a calculator tool. While we strive for accuracy, we are not responsible for any
          decisions made based on calculations performed using the Application. Always verify
          critical calculations independently.
        </Text>

        <Text style={styles.heading}>10. Indemnification</Text>
        <Text style={styles.paragraph}>
          You agree to indemnify, defend, and hold harmless calcAI, TearHappy, and our affiliates,
          ...
          with your access to or use of the Application or your violation of these Terms.
        </Text>

        <Text style={styles.heading}>11. Third-Party Services</Text>
        <Text style={styles.paragraph}>
          The Application may integrate with third-party services (such as webhook endpoints you
          configure). We are not responsible for the availability, accuracy, or content of these
        ...
        <Text style={styles.paragraph}>
          We reserve the right to terminate or suspend your access to the Application immediately,
          without prior notice or liability, for any reason, including breach of these Terms. Upon
          termination, your right to use the Application will immediately cease. If you wish to
          terminate your account, you may contact us at support@tearhappy.com.
        </Text>

        <Text style={styles.heading}>13. Governing Law and Dispute Resolution</Text>
        <Text style={styles.paragraph}>
          These Terms shall be governed by and construed in accordance with the laws of the
          jurisdiction in which TearHappy operates, without regard to its conflict of law
          provisions. Any disputes arising from these Terms or your use of the Application shall be
        ...
        <Text style={styles.paragraph}>
          ...
          continued use of the Application after such changes constitutes your acceptance of the new
          Terms.
        </Text>
